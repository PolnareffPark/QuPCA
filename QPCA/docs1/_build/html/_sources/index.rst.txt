...
* :mod:`~QPCA.benchmark` module: in this module, you find the :class:`~QPCA.benchmark.Benchmark_Manager` class that manages all the benchmarking by exploiting the implemented methods to benchmark the execution of Qpca algorithm.
